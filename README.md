...
| [Newton's method for finding the square root of a number](https://github.com/microamp/algorithms.py/master/dijkstra.py)(https://en.wikipedia.org/wiki/Newton%27s_method)                  | [sqrt.py](https://github.com/microamp/algorithms.py/blob/master/sqrt.py)                                       |
